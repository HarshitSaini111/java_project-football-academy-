...
<title>Performance Stats - Gamers Arena</title>
<style>
* {
  margin: 0;
  padding: 0;
...
<div class="container">
  <aside class="sidebar">
    ...
    <ul class="nav">
      ...
      <li><a href="performance.jsp" class="active">Stats</a></li>
      <li><a href="schedule.jsp">Tournaments</a></li>
  ...
  <main class="main-content">
    <div class="page-title">
      ...
      <p>Track your gaming progress and statistics</p>
    </div>
      ...
      <div class="performance-card">
        ...
        <div class="progress-item">
          <div class="progress-header">
            ...
            <span class="progress-value">15 Wins</span>
          </div>
          <div class="progress-bar">
        ...
        <div class="progress-item">
          <div class="progress-header">
            ...
            <span class="progress-value">18 Wins</span>
          </div>
          <div class="progress-bar">
        ...
        <div class="progress-item">
          <div class="progress-header">
            ...
            <span class="progress-value">12 Wins</span>
          </div>
          <div class="progress-bar">
        ...
        <div class="progress-item">
          <div class="progress-header">
            ...
            <span class="progress-value">342 hrs</span>
          </div>
          <div class="progress-bar">
        ...
        <div class="progress-item">
          <div class="progress-header">
            ...
            <span class="progress-value">37.5%</span>
          </div>
          <div class="progress-bar">
